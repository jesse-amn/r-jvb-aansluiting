...
fit <- fitMeasures(interesse$interesse)
...
# N
lavInspect(interesse$interesse, what = "nobs")

# Explained variance
r2 <- inspect(interesse$interesse, what = "r2")

# Factor loadings
loadings <- parameterEstimates(interesse$interesse)[parameterEstimates(interesse$interesse)$op == "=~", ][c("rhs", "est")]
weights <- inspect(interesse$interesse, what = "std")[["lambda"]] # These are the factor score coefficients, which are used to compute factor scores for each observation in your data.
```

##### Model Beoordeling

Hieronder volgen alle model fit van de factor analyse voor interesse. Hierbij moet rekening gehouden worden dat de factor analyses expliciet gemaakt zijn met 10 factoren,
en de onderliggende bijbehorende vragen alleen laden op de voor ingestelde factor. 
...
df <- data.frame(
  ...
  Result = c(p, rmsea, tli, rms, cfi),
  Cut_off = c("> .05", "< .05 | .05 - .1 | > .1", "> .95 | .90 - .95 | < .90", "< .08 | .08 - .10 | > .10", "> .95 | .90 - .95 | < .90"),
  Conclusion = c("Poor", "Acceptabel", "Poor", "Good", "Poor")
)
...
- ASL_interesse_049_sociaal_1    : 0.2675367
- ASL_interesse_002_realistisch_1: 0.1673608
- ASL_interesse_001_realistisch_1: 0.1656952

Hier volgen nog de gewichten van alle vragen op diens eigen factoren:

**Tabel 4: Betekenissen - Model-fit statistieken**

```{r interesse - Weights, echo=FALSE, message=FALSE, warning=FALSE}
knitr::kable(weights)
```
...
#### Item Response Analyse
```{r interesse  - load data, echo=FALSE, message=FALSE, warning=FALSE, results='hide'}
# load data
irt_fit <- readRDS(paste0(here(), "/data/item_analyses_pers2024/irt_fit_interesse.rds"))
data <- read.csv(paste0(here(), "/data/data_interrim/interesse.csv"))
```

##### Realistisch

```{r interesse realistisch - stat extraction, echo=FALSE, message=FALSE, warning=FALSE, results='hide'}
# Model fit
fit <- irt_fit$interesse_realistisch_irt_fit
...
```{r interesse realistisch - model fit, echo=FALSE, message=FALSE, warning=FALSE}
# model_fit$`Conclusion` <- c("", "", "Poor", "Acceptable", "", "", "Good", "Poor", "Poor")
# knitr::kable(model_fit)
```
...
```{r interesse realistisch - item fit, echo=FALSE, message=FALSE, warning=FALSE}
# knitr::kable(item_fit)
```
...
```{r interesse realistisch - robust item fit, echo=FALSE, message=FALSE, warning=FALSE}
knitr::kable(robust_item_fit)
```
...
```{r interesse realistisch - item parameters, echo=FALSE, message=FALSE, warning=FALSE}
knitr::kable(params)
```

##### Conventioneel

```{r interesse conventioneel - stat extraction, echo=FALSE, message=FALSE, warning=FALSE, results='hide'}
# Model fit
fit <- irt_fit$interesse_conventioneel_irt_fit
...
```{r interesse conventioneel - model fit, echo=FALSE, message=FALSE, warning=FALSE}
model_fit$`Conclusion` <- c("", "", "Poor", "Good", "", "", "Good", "Poor", "Acceptabel")
knitr::kable(model_fit)
```
...
```{r interesse conventioneel - item fit, echo=FALSE, message=FALSE, warning=FALSE}
knitr::kable(item_fit)
```
...
```{r interesse conventioneel - robust item fit, echo=FALSE, message=FALSE, warning=FALSE}
knitr::kable(robust_item_fit)
```
...
```{r interesse conventioneel - item parameters, echo=FALSE, message=FALSE, warning=FALSE}
knitr::kable(params)
```
...
```{r interesse ondernemend - stat extraction, echo=FALSE, message=FALSE, warning=FALSE, results='hide'}
# Model fit
fit <- irt_fit$interesse_ondernemend_irt_fit
...
```{r interesse ondernemend - model fit, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r interesse ondernemend - item fit, echo=FALSE, message=FALSE, warning=FALSE}
knitr::kable(item_fit)
```
...
```{r interesse ondernemend - robust item fit, echo=FALSE, message=FALSE, warning=FALSE}
knitr::kable(robust_item_fit)
```
...
```{r interesse ondernemend - item parameters, echo=FALSE, message=FALSE, warning=FALSE}
knitr::kable(params)
```

##### intellectueel

```{r interesse intellectueel - stat extraction, echo=FALSE, message=FALSE, warning=FALSE, results='hide'}
# Model fit
fit <- irt_fit$interesse_intellectueel_irt_fit
...
```{r interesse intellectueel - model fit, echo=FALSE, message=FALSE, warning=FALSE}
# model_fit$`Conclusion` <- c("", "", "Poor", "Good", "", "", "Good", "Poor", "Acceptabel")
# knitr::kable(model_fit)
```
...
```{r interesse intellectueel - item fit, echo=FALSE, message=FALSE, warning=FALSE}
knitr::kable(item_fit)
```
...
```{r interesse intellectueel - robust item fit, echo=FALSE, message=FALSE, warning=FALSE}
knitr::kable(robust_item_fit)
```
...
```{r interesse intellectueel - item parameters, echo=FALSE, message=FALSE, warning=FALSE}
knitr::kable(params)
```
...
```{r interesse artistiek - stat extraction, echo=FALSE, message=FALSE, warning=FALSE, results='hide'}
# Model fit
fit <- irt_fit$interesse_artistiek_irt_fit
...
```{r interesse artistiek - model fit, echo=FALSE, message=FALSE, warning=FALSE}
# model_fit$`Conclusion` <- c("", "", "Poor", "Good", "", "", "Good", "Poor", "Acceptabel")
# knitr::kable(model_fit)
```
...
```{r interesse artistiek - item fit, echo=FALSE, message=FALSE, warning=FALSE}
knitr::kable(item_fit)
```
...
```{r interesse artistiek - robust item fit, echo=FALSE, message=FALSE, warning=FALSE}
knitr::kable(robust_item_fit)
```
...
```{r interesse artistiek - item parameters, echo=FALSE, message=FALSE, warning=FALSE}
knitr::kable(params)
```
...
```{r interesse sociaal - stat extraction, echo=FALSE, message=FALSE, warning=FALSE, results='hide'}
# Model fit
fit <- irt_fit$interesse_sociaal_irt_fit
...
```{r interesse sociaal - model fit, echo=FALSE, message=FALSE, warning=FALSE}
# model_fit$`Conclusion` <- c("", "", "Poor", "Good", "", "", "Good", "Poor", "Acceptabel")
# knitr::kable(model_fit)
```
...
```{r interesse sociaal - item fit, echo=FALSE, message=FALSE, warning=FALSE}
# knitr::kable(item_fit)
```
...
```{r interesse sociaal - robust item fit, echo=FALSE, message=FALSE, warning=FALSE}
knitr::kable(robust_item_fit)
```
...
```{r interesse sociaal - item parameters, echo=FALSE, message=FALSE, warning=FALSE}
knitr::kable(params)
```
...
```{r interesse realistisch - number to names, echo=FALSE, message=FALSE, warning=FALSE}
irt_fit <- readRDS(paste0(here(), "/data/item_analyses_pers2024/irt_fit_interesse.rds"))
...
![](/Users/jesse/Repos/r-jvb-aansluiting/data/item_analyses_pers`r format(Sys.Date(), "%Y")`/graphs/interesse_realistisch_irt_fit_ICC_combined.png)

![](/Users/jesse/Repos/r-jvb-aansluiting/data/item_analyses_pers`r format(Sys.Date(), "%Y")`/graphs/interesse_realistisch_irt_fit_IIC_combined.png)

![](/Users/jesse/Repos/r-jvb-aansluiting/data/item_analyses_pers`r format(Sys.Date(), "%Y")`/graphs/interesse_realistisch_irt_fit_IIC_separate.png)

![](/Users/jesse/Repos/r-jvb-aansluiting/data/item_analyses_pers`r format(Sys.Date(), "%Y")`/graphs/interesse_realistisch_irt_fit_TCC.png)

![](/Users/jesse/Repos/r-jvb-aansluiting/data/item_analyses_pers`r format(Sys.Date(), "%Y")`/graphs/interesse_realistisch_irt_fit_TIC.png)



#### Conventioneel

```{r interesse conventioneel - number to names, echo=FALSE, message=FALSE, warning=FALSE}
irt_fit <- readRDS(paste0(here(), "/data/item_analyses_pers2024/irt_fit_interesse.rds"))
...
![](/Users/jesse/Repos/r-jvb-aansluiting/data/item_analyses_pers`r format(Sys.Date(), "%Y")`/graphs/interesse_conventioneel_irt_fit_ICC_combined.png)

![](/Users/jesse/Repos/r-jvb-aansluiting/data/item_analyses_pers`r format(Sys.Date(), "%Y")`/graphs/interesse_conventioneel_irt_fit_IIC_combined.png)

![](/Users/jesse/Repos/r-jvb-aansluiting/data/item_analyses_pers`r format(Sys.Date(), "%Y")`/graphs/interesse_conventioneel_irt_fit_IIC_separate.png)

![](/Users/jesse/Repos/r-jvb-aansluiting/data/item_analyses_pers`r format(Sys.Date(), "%Y")`/graphs/interesse_conventioneel_irt_fit_TCC.png)

![](/Users/jesse/Repos/r-jvb-aansluiting/data/item_analyses_pers`r format(Sys.Date(), "%Y")`/graphs/interesse_conventioneel_irt_fit_TIC.png)


#### Ondernemend

```{r interesse ondernemend - number to names, echo=FALSE, message=FALSE, warning=FALSE}
irt_fit <- readRDS(paste0(here(), "/data/item_analyses_pers2024/irt_fit_interesse.rds"))
...
![](/Users/jesse/Repos/r-jvb-aansluiting/data/item_analyses_pers`r format(Sys.Date(), "%Y")`/graphs/interesse_ondernemend_irt_fit_ICC_combined.png)

![](/Users/jesse/Repos/r-jvb-aansluiting/data/item_analyses_pers`r format(Sys.Date(), "%Y")`/graphs/interesse_ondernemend_irt_fit_IIC_combined.png)

![](/Users/jesse/Repos/r-jvb-aansluiting/data/item_analyses_pers`r format(Sys.Date(), "%Y")`/graphs/interesse_ondernemend_irt_fit_IIC_separate.png)

![](/Users/jesse/Repos/r-jvb-aansluiting/data/item_analyses_pers`r format(Sys.Date(), "%Y")`/graphs/interesse_ondernemend_irt_fit_TCC.png)

![](/Users/jesse/Repos/r-jvb-aansluiting/data/item_analyses_pers`r format(Sys.Date(), "%Y")`/graphs/interesse_ondernemend_irt_fit_TIC.png)


#### Intellectueel

```{r interesse intellectueel - number to names, echo=FALSE, message=FALSE, warning=FALSE}
irt_fit <- readRDS(paste0(here(), "/data/item_analyses_pers2024/irt_fit_interesse.rds"))
...
![](/Users/jesse/Repos/r-jvb-aansluiting/data/item_analyses_pers`r format(Sys.Date(), "%Y")`/graphs/interesse_intellectueel_irt_fit_ICC_combined.png)

![](/Users/jesse/Repos/r-jvb-aansluiting/data/item_analyses_pers`r format(Sys.Date(), "%Y")`/graphs/interesse_intellectueel_irt_fit_IIC_combined.png)

![](/Users/jesse/Repos/r-jvb-aansluiting/data/item_analyses_pers`r format(Sys.Date(), "%Y")`/graphs/interesse_intellectueel_irt_fit_IIC_separate.png)

![](/Users/jesse/Repos/r-jvb-aansluiting/data/item_analyses_pers`r format(Sys.Date(), "%Y")`/graphs/interesse_intellectueel_irt_fit_TCC.png)

![](/Users/jesse/Repos/r-jvb-aansluiting/data/item_analyses_pers`r format(Sys.Date(), "%Y")`/graphs/interesse_intellectueel_irt_fit_TIC.png)


#### artistiek

```{r interesse artistiek - number to names, echo=FALSE, message=FALSE, warning=FALSE}
irt_fit <- readRDS(paste0(here(), "/data/item_analyses_pers2024/irt_fit_interesse.rds"))
...
![](/Users/jesse/Repos/r-jvb-aansluiting/data/item_analyses_pers`r format(Sys.Date(), "%Y")`/graphs/interesse_artistiek_irt_fit_ICC_combined.png)

![](/Users/jesse/Repos/r-jvb-aansluiting/data/item_analyses_pers`r format(Sys.Date(), "%Y")`/graphs/interesse_artistiek_irt_fit_IIC_combined.png)

![](/Users/jesse/Repos/r-jvb-aansluiting/data/item_analyses_pers`r format(Sys.Date(), "%Y")`/graphs/interesse_artistiek_irt_fit_IIC_separate.png)

![](/Users/jesse/Repos/r-jvb-aansluiting/data/item_analyses_pers`r format(Sys.Date(), "%Y")`/graphs/interesse_artistiek_irt_fit_TCC.png)

![](/Users/jesse/Repos/r-jvb-aansluiting/data/item_analyses_pers`r format(Sys.Date(), "%Y")`/graphs/interesse_artistiek_irt_fit_TIC.png)


#### Sociaal

```{r interesse sociaal - number to names, echo=FALSE, message=FALSE, warning=FALSE}
irt_fit <- readRDS(paste0(here(), "/data/item_analyses_pers2024/irt_fit_interesse.rds"))
...
![](/Users/jesse/Repos/r-jvb-aansluiting/data/item_analyses_pers`r format(Sys.Date(), "%Y")`/graphs/interesse_sociaal_irt_fit_ICC_combined.png)

![](/Users/jesse/Repos/r-jvb-aansluiting/data/item_analyses_pers`r format(Sys.Date(), "%Y")`/graphs/interesse_sociaal_irt_fit_IIC_combined.png)

![](/Users/jesse/Repos/r-jvb-aansluiting/data/item_analyses_pers`r format(Sys.Date(), "%Y")`/graphs/interesse_sociaal_irt_fit_IIC_separate.png)

![](/Users/jesse/Repos/r-jvb-aansluiting/data/item_analyses_pers`r format(Sys.Date(), "%Y")`/graphs/interesse_sociaal_irt_fit_TCC.png)

![](/Users/jesse/Repos/r-jvb-aansluiting/data/item_analyses_pers`r format(Sys.Date(), "%Y")`/graphs/interesse_sociaal_irt_fit_TIC.png)
